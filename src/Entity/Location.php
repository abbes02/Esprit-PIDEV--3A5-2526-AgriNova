...
#[ORM\Table(name: 'location_web', indexes: [
    new ORM\Index(name: 'fk_location_web_materiel', columns: ['materiel_id']),
    new ORM\Index(name: 'fk_location_web_user', columns: ['utilisateur_id']),
])]
class Location
{
