...
class Formation
{
    ...
    #[ORM\OneToMany(mappedBy: 'formation', targetEntity: Evenement::class, cascade: ['persist'])]
    ...
    public function setDureeHeures(int $dureeHeures): static { $this->dureeHeures = $dureeHeures; return $this; }
